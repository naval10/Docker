pipeline {
    ...
    stages{
        ...
        stage('Stash folders'){
            steps{
                sh 'sudo tar -cvf demo.tar ansible docker target/addressbook.war'
        ...
        stage('Run Playbook'){
            ...
            steps{
                sh 'ansible-playbook ansible/playbooks/main.yml -i ansible/inventories/production/aws_ec2.yml'
            }
        }
    }
